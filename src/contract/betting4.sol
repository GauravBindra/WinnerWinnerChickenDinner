...
contract BettingGame is VRFConsumerBaseV2, ReentrancyGuard {
    ...
    // subscriptionId = 56320726399201691331904973166290281293821226043811703980205123577651804321058; this is causing the error - because subscription uses vrf2.5 and 
    // i am not able to figure out direct funding method in vrf 2.0
    // bytes32 s_keyHash = 0x474e34a077df58807dbe9c96d3c009b23b3c6d0cce433e59bbf5b34f823bc56c;

// creation of BettingGame errored: Error encoding arguments: Error: value out-of-bounds (argument=null, value="56320726399201691331904973166290281293821226043811703980205123577651804321058", code=INVALID_ARGUME
